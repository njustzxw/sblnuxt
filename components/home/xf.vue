...
export default {
  ...
  methods: {
    gotoHead(item) {
      setStore("servicename", item.name);
    ...
    openkf() {
      window.open(
        "http://p.qiao.baidu.com/cps/chatIndex?reqParam=%7B%22from%22%3A0%2C%22sid%22%3A%22-100%22%2C%22tid%22%3A%22-1%22%2C%22ttype%22%3A1%2C%22siteId%22%3A%2212276989%22%2C%22userId%22%3A%2225904580%22%2C%22pageId%22%3A0%7D&qq-pf-to=pcqq.c2c ",
        "newwindow",
...
.left-navbar .self,
.left-navbar .shop-cart,
.left-navbar .contact,
.left-navbar .guanzhu,
.left-navbar .shoucang,
.totop,
.ewm {
  position: relative;
  /* margin: 20px 0; */
...
.left-navbar .guanzhu a,
.left-navbar .shoucang a,
.left-navbar .gotop,
.ewm .icon {
  display: block;
  height: 35px;
...
.left-navbar .self div,
.left-navbar .contact div,
.left-navbar .guanzhu div,
.left-navbar .shoucang div,
.left-navbar .mes {
  position: absolute;
  right: 35px;
...
.left-navbar .self:hover .icon,
.left-navbar .shop-cart:hover .cart-intro i,
.left-navbar .contact:hover a,
.left-navbar .guanzhu:hover a,
.left-navbar .shoucang:hover a,
.ewm:hover .icon,
.totop:hover .gotop {
  background-color: #f64239;
}
