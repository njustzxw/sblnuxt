...
export default {
  ...
  mounted() {
    ...
    this.treedata = getStore("treedata");
  },
  computed: {
    userInfo() {
    ...
    // treedata() {
    //   console.log(getStore("treedata"));
    //   return JSON.parse(getStore("treedata"));
    // }
  },
  methods: {
